package com.searoth.kotlin.mvvm.other
...
class Models{
    ...
    class FoodItem(val name: String, val rating: Float, val price: Double, var description: String,
                   var notes: String, val ingredients: Array<String>, val imageUrl: String, val id: Int, val business: Business)
