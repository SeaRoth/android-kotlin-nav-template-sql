...
import com.searoth.kotlin.mvvm.data.source.remote.MealsRemoteDataSource
...
object Injection {
    ...
    fun provideMealsRepository(context: Context): MealsRepository {
        ...
        return MealsRepository.getInstance(MealsRemoteDataSource.getInstance(AppExecutors()),
